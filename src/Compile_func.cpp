...
bool Compile_func(int argc, char* argv[]) {
    ...
    DEBUG_PRINTF("MY ASM DONE\n");
    getchar();

    if(Input_files[Dbg_file_index]) {
        Tree_graph_debug(root, Input_files[Dbg_file_index], &Print_node_data);
    }
